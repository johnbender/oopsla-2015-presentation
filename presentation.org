...
** classic
   |            |                     | *x86*        | *ARMv7*      |
   | *Dekker*   | \stldorder{8}{9}    | 8: ~mfence~  | 8: ~dmb st~  |
   |            | \stldorder{13}{9}   | 13: ~mfence~ | 13: ~dmb st~ |
   |            | \stldorder{25}{26}  | 25: ~mfence~ | 25: ~dmb st~ |
   |            | \stldorder{30}{26}  | 30: ~mfence~ | 30: ~dmb st~ |
   |            |                     |              |              |
   | *Lamport*  | \stldorder{8}{9}    | 8: ~mfence~  | 8: ~dmb st~  |
   |            | \stldorder{14}{15}  | 14: ~mfence~ | 14: ~dmb st~ |
   |            | \stldorder{31}{32}  | 31: ~mfence~ | 31: ~dmb st~ |
   |            | \stldorder{37}{38}  | 37: ~mfence~ | 37: ~dmb st~ |
   |            |                     |              |              |
   | *Parker*   | \stanyorder{44}{46} | 44: ~mfence~ | 44: ~dmb st~ |
   |            |                     |              |              |
   | *Peterson* | \stldorder{5}{7}    | 5: ~mfence~  | 5: ~dmb st~  |
   |            | \stldorder{14}{16}  | 14: ~mfence~ | 14: ~dmb st~ |

   #+BEGIN_NOTES
   For the classic algorithms we fences were placed in expected locations

   Explain how to read the table.1
   #+END_NOTES

** tl2
   |                        |                | *x86* |                         | *ARMv7*                |
   | \ttf{TxStore}          | baseline       | ours  | baseline                | ours                   |
   | \ldldorder{1886}{1923} | ---            | ---   | 1920: ~dmb~           | 1886: ~dmb~          |
   |                        |                |       |                         |                        |
   | \ttf{TxCommit}         | baseline       | ours  | baseline                | ours                   |
   | \ststorder{1555}{1625} | ---            | ---   | 1555: \ttf{ldrex/strex} | 1555:\ttf{ldrex/strex} |
   | \ststorder{1596}{1625} | ---            | ---   | 1596: \ttf{ldrex/strex} | 1596:\ttf{ldrex/strex} |
   | \ststorder{760}{1413}  | ---            | ---   | 1669: ~dmb st~          | 1669: ~dmb st~         |
   | \stldorder{1413}{1679} | 1679: ~mfence~ | ---   | 1679: ~dmb st~          | 1416: ~dmb st~         |
...
** tl2 eager
   ...
   |------------------------+----------------+-------+----------------+----------------|
   | \ttf{TxCommit}         | baseline       | ours  | baseline       | ours           |
   | \ststorder{760}{1413}  | ---            | ---   | 1669: ~dmb st~ | ---            |
   | \stldorder{1413}{1679} | 1679: ~mfence~ | ---   | 1679: ~dmb st~ | 1679: ~dmb st~ |
...
** rstm
   |                      |                | *x86*         |                       | *ARMv7*       |
   | \ttf{read\_rw}       | baseline       | ours          | baseline              | ours          |
   | \stldorder{163}{165} | 163:\ttf{xchg} | 163: ~mfence~ | 163:\ttf{ldrex/strex} | 163: ~dmb st~ |
...
** rstm performance
   file:./assets/images/stamp-x86-rstm.png
** rstm performance

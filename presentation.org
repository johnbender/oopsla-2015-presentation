...
** good execution
   ...
   - key: no way to mix up the instructions s.t. both can proceed
   #+END_NOTES
...
** bad execution
   ...
   - it's now for both flag checks to see ~false~
   #+END_NOTES
...
** traditional solutions
   ...
   - precise placement matters for performance correctness
   #+END_NOTES
